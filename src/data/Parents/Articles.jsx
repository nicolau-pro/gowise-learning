...
const data = [
  {
    ...
    paragraphs: [
      ...
      "We take time to listen, understand, and create bespoke teaching strategies that match your child's strengths, interests, and areas of development.",
      "Our work goes beyond academics. We focus on the whole child, linking their wellbeing, confidence, and happiness with their progress in learning",
    ],
  },
  {
    theme: "primary",
